...
kubectl -n test exec deployment/flagger-loadtester -- curl -s -H "Canary-Name: podinfo" -H "Canary-Namespace: test"  -d '{"weight": 60, "paused": true}' http://flagger-loadtester.test/traffic/
